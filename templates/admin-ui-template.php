                    ...
                    <transition-group name="fade-up" target="div" appear>
                        <div class="content-tab" :key="index">
                            ...
                            <div class="wookit-switch" v-if="option.tab1">
                                <div class="opt-col-6">
                                    <h3>
                                        <?php echo esc_html__('Moving non-existent products to the bottom of the store list', 'dominokit') ?>
                                    </h3>
                                    <p>
                                        <?php echo esc_html__('If your template has this feature, please disable it', 'dominokit') ?>
                                    </p>
                                </div>
                            ...
                            <div class="wookit-switch" v-if="option.tab1">
                                <div class="opt-col-6">
                                    <h3><?php echo esc_html__('Changing the default WooCommerce button (add to cart)', 'dominokit') ?></h3>
                                    <p><?php echo esc_html__('If your template has this feature, please disable it', 'dominokit') ?></p>
                                </div>
                                <div class="opt-col-6 opt-title">
                                    <label class="switch">
                                ...
                                <transition name="fade-up" target="div" appear>
                                    <div class="form-group btnWooCart" v-if="wooCart">
                                        <label for="txt-cart"><?php echo esc_html__('Add to cart button', 'dominokit') ?></label>
