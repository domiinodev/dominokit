...
class DominoKitController
{
    ...
    {
        $this->dominokit_options[0]['title'] = esc_html__('Appearance', 'dominokit');
        $this->dominokit_options[0]['description'] = esc_html__('Features that affect the appearance of the website', 'dominokit');
        $this->dominokit_options[0]['tab1'] = true;
        $this->dominokit_options[0]['tab2'] = false;
        $this->dominokit_options[0]['tab3'] = false;
        $this->dominokit_options[0]['errorTxt'] = esc_html__('The address is not correct', 'dominokit');

        $this->dominokit_options[1]['title'] = esc_html__('solarization', 'dominokit');
        $this->dominokit_options[1]['description'] = esc_html__('Keep in mind that if you enable these options, the Shamsi Saaz plugin will not be active', 'dominokit');
